...
## :star: [Live Demo](https://66a17c7122467d55b9257c3e--stellar-palmier-168a1c.netlify.app/) :star:
...
- On the project, GitHub page, navigate to the [main page of the repository](https://github.com/mrigorir/angular-maps-app)
...
- Type `git clone`, and then paste the URL you copied in Step 3.<br>
  ...
  `$ git clone git@github.com:mrigorir/angular-maps-app.git` <em>Press Enter key</em><br>
